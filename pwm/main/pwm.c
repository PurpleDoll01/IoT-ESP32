...
void app_main(void)
{
    ...
    while (1)
    {
        ...
        printf("adc raw: %d", raw_value);

        // Establece el nuevo valor en la configuracion en porcentaje de energía
        ledc_set_duty(LEDC_MODE, LEDC_CHANNEL_0, raw_value);

        // Saca fisicamente la señal
